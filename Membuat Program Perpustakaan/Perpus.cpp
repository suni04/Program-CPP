...
mulaimenu: //mulai menu
  ...
  inbuk:
    ...
    cout << " Kode Buku \t\t:";
    scanf("%d%c", &buku[b].kodeB, &temp);
    cout << " judul Buku\t\t:";
    gets(buku[b].judul);
    cout << " Harga Sewa \t\t:";
    scanf("%d%c", &buku[b].sewa, &temp);
    cout << " Jumlah Buku\t\t:";
    scanf("%d%c", &buku[b].stock, &temp);
    cout << endl;
  ...
  { // melihat daftar buku yang sudah di masukkan
    system("cls");
    cout << "\n"
         << endl;
  ...
  { // Input transaksi peminjaman Buku
  transaksipinjem:
    d++;
    system("cls");
    cout << "\n"
    ...
    cout << " Kode Pinjaman \t\t\t:";
    scanf("%d%c", &pinjembuku[d].kodepinjam, &temp);
    cout << " Kode Buku \t\t\t:";
    scanf("%d%c", &pinjembuku[d].kB, &temp);
  ...
  pengembalian:
    ...
    cin >> kodepin; //memasukan kode peminjaman
    cout << "\t\t\t____________________\n"
         << endl;
    cout << endl;
    for (f = 0; f <= d; f++)
